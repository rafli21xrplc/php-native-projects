...
if (isset($_POST["submit"])) {
  ...
  $KEYRANDOM = password_hash(rand(1, 5), PASSWORD_DEFAULT);
  ...
  if (mysqli_num_rows($duplicate) > 0) {
    ...
    if ($password == $cpassword) {
      $query = "INSERT INTO login VALUES('$random','$username','$email','$password')";
    ...
    <div class="flex justify-center self-center  z-10">
      <form action="" method="post">
        <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
          ...
          <div class="space-y-6">
            <div class="">
              <input class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="text" name="username" placeholder="username">
            </div>

            <div class="">
              <input class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="text" name="email" placeholder="Email">
            </div>


            <div class="relative" x-data="{ show: true }">
              <input placeholder="Password" :type="show ? 'password' : 'text'" name="password" class="text-sm text-black px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
            ...
            <div class="relative" x-data="{ show: true }">
              <input placeholder="Password" :type="show ? 'password' : 'text'" name="cpassword" class="text-sm text-black px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
              <div class="flex items-center absolute inset-y-0 right-0 mr-3  text-sm leading-5">
          ...
          <div class="mt-7 text-center text-gray-300 text-xs">
            <span>
              Copyright © 2021-2023
              <a href="https://codepen.io/uidesignhub" rel="" target="_blank" title="NEUTURAL" class="text-purple-500 hover:text-purple-600 ">NEUTURAL</a></span>
          </div>
        </div>
      </form>
    </div>
