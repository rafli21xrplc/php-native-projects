...
<body>
    <div class="container my-5">
        ...
        <a href="/mycrud/daftar_guru.php"><button type="button" class="btn btn-outline-dark"><b>Tambah Data</b></button></a>
        <br>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>$row[alamat]</td>
                        <td>$row[gender]</td>
                        <td colspan='1'><img width='100' height='80' src='images/".$row['foto']."'></td>
                        <td>
                            <a class='btn btn-primary btn-sm' href='edit_guru.php?id=" . $row['id_guru'] . " '>edit</a>
                            <a onclick='return confirm(`yakin ingin menghapus?`)' class='btn btn-primary btn-sm' href='hapus_guru.php?id=" . $row['id_guru'] ." '>delete</a>
                        </td>
                    </tr>
                    ";
