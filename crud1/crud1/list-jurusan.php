...
<body>
    <header>
         <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                  <a class="navbar-brand text-uppercase fw-bold" href="#page-top">Jurusan</a>
    ...
    <nav>
        <div class="d-grid gap-2 col-6 mx-auto">
         <a class="btn btn-primary" href="daftar-jurusan.php">[+] Tambah Baru</a>
    ...
    <tbody>
        ...
        while($siswa = mysqli_fetch_array($query)){
            ...
            echo "<td colspan='1'>".$siswa['pemegang']."</td>";
            echo "<td colspan='1'><img width='40' height='50' src='imagesjurusan/".$siswa['nameImage']."'></td>";

            echo "<td colspan='1'>";
            echo "<a href='edit-jurusan.php?id=".$siswa['id']."'>Edit</a> | ";
            echo "<a onclick='return confirm(`yakin ingin menghapus?`)' href='hapus-jurusan.php?id=".$siswa['id']."'>Hapus</a>";
            echo "</td>";
