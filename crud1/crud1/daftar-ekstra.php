...
<head>
    ...
    <title>Formulir Pendaftaran Jurusan</title>
</head>
...
<body>
    ...
    <form action="proses-ekstra.php" method="POST" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="card-body">
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="pembimbing" required="" class="form-control">
                    </div>
                    ...
                    <div class="col-md-12">
                        <label  class="form-label">Ekstrakulikuler</label>
                            <select name="tempat"  id="" class="form-select">
                                <option selected>Choose...</option>
                                <option>Halaman Sekolah</option>
                                <option>Lapangan</option>
                                <option>Lap. Volly</option>
                                <option>R. Jurnalis</option>
                                <option>Aula</option>
                            </select>
                    </div>
