...
<body>
    <header>
         <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                  <a class="navbar-brand text-uppercase fw-bold" href="#page-top">Edit Guru</a>
    ...
    <form action="progres-edit.php" method="POST" enctype="multipart/form-data">

        <fieldset>

            <div class="card">
                <div class="card-header bg-secondary fst-italic text-white">Edit Guru</div>
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="id" value="<?php echo $siswa['id'] ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" required="" class="form-control" value="<?php echo $siswa['nama'] ?>"/>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php $mapel = $siswa['mapel']; ?>                       
                            <select name="mapel"  id="" class="form-select">
                                <option <?php echo ($mapel == 'PWPB') ? "selected": "" ?>>PWPB</option>
                                <option <?php echo ($mapel == 'PBO') ? "selected": "" ?>>PBO</option>
                                <option <?php echo ($mapel == 'BD') ? "selected": "" ?>>BD</option>
                                <option <?php echo ($mapel == 'PKKWU') ? "selected": "" ?>>PKKWU</option>
                            </select>
                    </div>

                    <div class="col-md-12">
                        <label for="absen" class="form-label">Kehadiran</label>
                        <?php $absen = $siswa['absen']; ?>                       
                            <select name="absen"  id="" class="form-select">
                                <option <?php echo ($absen == 'Hadir') ? "selected": "" ?>>Hadir</option>
                                <option <?php echo ($absen == 'Ijin') ? "selected": "" ?>>Ijin</option>
                                <option <?php echo ($absen == 'Sakit') ? "selected": "" ?>>Sakit</option>
                            </select>
                    </div>
