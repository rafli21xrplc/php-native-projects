...
<body>
    <header>
         <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                  <a class="navbar-brand text-uppercase fw-bold" href="#page-top">Edit Siswa</a>
    ...
    <form action="proses-edit.php" method="POST" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="card">
                <div class="card-header bg-secondary fst-italic text-white">Edit Siswa</div>
            ...
            <input type="hidden" name="id" value="<?php echo $siswa['id'] ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <label><input type="radio" name="jenis_kelamin" value="L" <?= ($jk == 'L') ? "checked" : "" ?>> Laki-laki</label>
                        <label><input type="radio" name="jenis_kelamin" value="P" <?= ($jk == 'P') ? "checked" : "" ?>> Perempuan</label>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="nameImage">Foto</label>
