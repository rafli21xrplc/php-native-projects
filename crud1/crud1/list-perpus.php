...
<body>
    <header>
         <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                  <a class="navbar-brand text-uppercase fw-bold" href="#page-top">Perpustakaan</a>
    ...
    <nav>
        <div class="d-grid gap-2 col-6 mx-auto">
         <a class="btn btn-primary" href="daftar-perpus.php">[+] Tambah Baru</a>
    ...
    <thead>
        <tr>
            ...
            <th class="col">Kelas Peminjam</th>
    ...
    <tbody>
        ...
        while($siswa = mysqli_fetch_array($query)){
            ...
            echo "<td colspan='1'>".$siswa['buku']."</td>";
            echo "<td colspan='1'>".$siswa['peminjam']."</td>";
            echo "<td colspan='1'>".$siswa['kelas']."</td>";
            echo "<td colspan='1'><img width='40' height='50' src='imagesperpus/".$siswa['nameImage']."'></td>";

            echo "<td colspan='1'>";
            echo "<a href='edit-perpus.php?id=".$siswa['id']."'>Edit</a> | ";
            echo "<a onclick='return confirm(`yakin ingin menghapus?`)' href='hapus-perpus.php?id=".$siswa['id']."'>Hapus</a>";
            echo "</td>";
